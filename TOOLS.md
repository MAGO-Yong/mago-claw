...
- Personal Access Token: WBvJswqo-eYp3cLRqzAT
- 用途: clone 内部 GitLab 仓库

### GitHub (github.com)
- Personal Access Token: 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
- 仓库: MAGO-Yong/mago-claw
- Remote URL: https://<token>@github.com/MAGO-Yong/mago-claw.git
- 用途: workspace 备份、版本管理

### XRay 日志平台
- Auth Token: 8e487408-b08b-44e7-ab91-1cb3441aa936
