...
## 方案一：薯红经典（redbook-classic）

温暖、专业、辨识度高。适合品牌相关 / 红色风格诉求场景。

> 注：从 v2 起，本 skill 的**默认配色已切换为方案五「清澈青蓝（horizon-blue）」**，更适合通用文档场景。薯红仍作为重要备选保留。
...
## 方案五：清澈青蓝（horizon-blue）⭐ 默认

以清爽的青蓝色（Teal Blue）为主色调，搭配冷灰白底，营造现代、理性、技术感的视觉风格。**未指定配色时一律使用此方案**。
