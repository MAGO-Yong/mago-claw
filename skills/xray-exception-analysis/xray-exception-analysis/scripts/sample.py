...
接口: GET https://xray.devops.xiaohongshu.com/application/r/t/sample/batchIds
...
def main():
    parser = argparse.ArgumentParser(
        description="错慢请求采样 MessageId — GET /application/r/t/sample/batchIds"
    )
    ...
    url = f"{BASE_URL}/application/r/t/sample/batchIds?" + "&".join(params)
    print(
